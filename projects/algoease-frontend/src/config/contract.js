...
export const CONTRACT_CONFIG = {
  ...
  APP_ID: parseInt(process.env.REACT_APP_CONTRACT_APP_ID) || 748433709,
  ...
  DEPLOYMENT: {
    ...
    APPROVAL_PROGRAM_PATH: '../algoease-contracts/algoease_approval.teal',
    CLEAR_PROGRAM_PATH: '../algoease-contracts/algoease_clear.teal'
  },
